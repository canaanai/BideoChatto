...
public class CallFragment extends Fragment {
    ...
    toggleMuteButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        toggleMuteButton.setAlpha(enabled ? 1.0f : 0.3f);
          toggleMuteButton.setBackgroundResource(enabled ? R.drawable.audio_on : R.drawable.audio_off);
      }
    });
  ...
  public void onStart() {
    ...
    if (args != null) {
      ...
      String contactName = args.getString(CallActivity.EXTRA_USER_NAME);
      contactView.setText((contactName!=null)?contactName:RoomId);

...
public class MyWebSocketConnection implements WebSocket {
    private static final String TAG = MyWebSocketConnection.class.getName();
    ...
    private MyWebSocketConnection.SocketThread mSocketThread;
    ...
    public MyWebSocketConnection() {
        ...
        this.mHandler = new MyWebSocketConnection.ThreadHandler(this);
    }
    ...
    private void failConnection(WebSocketCloseNotification code, String reason) {
        ...
        if(this.mSocket != null) {
            this.mSocketThread.getHandler().post(new Runnable() {
                public void run() {
                    MyWebSocketConnection.this.mSocketThread.stopConnection();
                }
            });
        } else {
    ...
    private void connect() {
        this.mSocketThread = new MyWebSocketConnection.SocketThread(this.mWebSocketURI, this.mWebSocketOptions);
        this.mSocketThread.start();
        MyWebSocketConnection.SocketThread e = this.mSocketThread;
        ...
        this.mSocketThread.getHandler().post(new Runnable() {
            public void run() {
                MyWebSocketConnection.this.mSocketThread.startConnection();
            }
        });
    ...
    protected boolean scheduleReconnect() {
        ...
        if(shouldReconnect) {
            ...
            this.mHandler.postDelayed(new Runnable() {
                public void run() {
                    Log.d(MyWebSocketConnection.TAG, "WebSocket reconnecting...");
                    MyWebSocketConnection.this.reconnect();
                }
            }, (long)interval);
        }
    ...
    private void handleMessage(Message message) {
        ...
        if(message.obj instanceof TextMessage) {
            ...
            ServerHandshake error6 = (ServerHandshake)message.obj;
            ...
            Error error7 = (Error)message.obj;
            this.failConnection(WebSocketCloseNotification.INTERNAL_ERROR, "WebSockets internal error (" + error7.mException.toString() + ")");
    ...
    public static class SocketThread extends Thread {
        ...
        public void run() {
            ...
            Looper.loop();
            Log.d(MyWebSocketConnection.TAG, "SocketThread exited.");
        }
    ...
    private static class ThreadHandler extends Handler {
        private final WeakReference<MyWebSocketConnection> mWebSocketConnection;

        public ThreadHandler(MyWebSocketConnection webSocketConnection) {
            this.mWebSocketConnection = new WeakReference(webSocketConnection);
        }

        public void handleMessage(Message message) {
            MyWebSocketConnection webSocketConnection = (MyWebSocketConnection)this.mWebSocketConnection.get();
